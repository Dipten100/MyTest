...
<body>
 ...
 <?php 
  ...
  <br><br>
<center><a href="host.php"><button class="btn-primary btn">Add more question</button></a></center><br><br>
 <center>
  <?php 
  ...
  echo "<a href='../admin.php?name=$name'><button class='btn-primary btn'>Save</button></a>";
 ?>
 </center>
